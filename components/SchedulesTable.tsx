                    ...
                    <table className='min-w-full divide-y divide-gray-300 dark:divide-[#363b3d]'>
                      <thead className='bg-gray-50 dark:bg-[#1A1D1E]'>
                        <tr>
                          <th
                            scope='col'
                            className='dark:text-[#d8d4cf] text-center whitespace-nowrap py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6'
                          >
                            Date
                          </th>
                          <th
                            scope='col'
                            className='dark:text-[#d8d4cf] text-center whitespace-nowrap px-2 py-3.5 text-left text-sm font-semibold text-gray-900'
                          >
                            Weekday
                          </th>
                          <th scope='col' className='dark:text-[#d8d4cf] text-center px-2 py-3.5 text-left text-sm font-semibold text-gray-900'>
                            Location
                          </th>
                          <th scope='col' className='dark:text-[#d8d4cf] text-center px-2 py-3.5 text-left text-sm font-semibold text-gray-900'>
                            Court
                      ...
                      <tbody className='divide-y divide-gray-200 bg-white dark:divide-[#363b3d] dark:bg-[#1A1D1E]'>
                        {transactions.map((transaction) => (
                          <tr key={transaction.id}>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] whitespace-nowrap py-2 pl-4 pr-3 text-sm text-gray-500 sm:pl-6'>
                              {transaction.id}
                            </td>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] whitespace-nowrap px-2 py-2 text-sm font-medium text-gray-900'>
                              {transaction.company}
                            </td>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] whitespace-nowrap px-2 py-2 text-sm text-gray-900'>
                              {transaction.share}
                            </td>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] whitespace-nowrap px-2 py-2 text-sm text-gray-500'>
                              {transaction.commission}
                            </td>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] text-center whitespace-nowrap px-2 py-2 text-sm text-gray-500'>
                              {transaction.price}
                            </td>
                            <td className='dark:text-[#d8d4cf] dark:bg-[#1A1D1E] text-center whitespace-nowrap px-2 py-2 text-sm text-gray-500'>
